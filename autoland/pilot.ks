...
set RUNWAY_WEST_THRESHOLD_POS to LATLNG(RUNWAY_WEST_THRESHOLD_LAT, RUNWAY_WEST_THRESHOLD_LNG).
set RUNWAY_EAST_THRESHOLD_POS to LATLNG(RUNWAY_EAST_THRESHOLD_LAT, RUNWAY_EAST_THRESHOLD_LNG).

run "autoland/lib_pid".
...
set runway_alt to body:altitudeof(RUNWAY_WEST_THRESHOLD_POS:position).

lock runway_vect to (RUNWAY_EAST_THRESHOLD_POS:position - RUNWAY_WEST_THRESHOLD_POS:position):normalized.
...
local aim_pos is RUNWAY_EAST_THRESHOLD_POS:altitudeposition(0).
...
until i >= 5 {
  ...
  local aim_pos is RUNWAY_WEST_THRESHOLD_POS:altitudeposition(aim_alt) - (120 + 1500*arith_series)*runway_vect.
...
until user_quit or status="LANDED" or cur_aim_i < 0 {
  ...
  if cur_aim_i > 0 {
    ...
    if (RUNWAY_EAST_THRESHOLD_POS:position - ship:position):mag < (RUNWAY_WEST_THRESHOLD_POS:position - ship:position):mag {
